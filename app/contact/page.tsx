        ...
        <div className="mx-auto max-w-7xl">
          <div className="overflow-hidden rounded-xl bg-[#1A1A2E] text-white shadow-sm">
            <div className="grid gap-8 p-8 sm:p-10 lg:grid-cols-[1fr_360px] lg:p-12">
              <div>
                <p className="text-sm font-bold uppercase tracking-[.2em] text-[#00C9A7]">Contact Proppd</p>
                ...
                <div className="mt-8 grid gap-3 sm:grid-cols-3">
                  <div className="rounded-2xl border border-white/10 bg-white/6 p-4">
                    <p className="text-xs font-bold uppercase tracking-[.16em] text-[#00C9A7]">Fastest route</p>
                    <p className="mt-2 text-sm font-bold leading-6 text-white/72">Send the page link, suburb, and what you need fixed or routed.</p>
                  </div>
                  <div className="rounded-2xl border border-white/10 bg-white/6 p-4">
                    <p className="text-xs font-bold uppercase tracking-[.16em] text-[#00C9A7]">Agency onboarding</p>
                  ...
                  <div className="rounded-2xl border border-white/10 bg-white/6 p-4">
                    <p className="text-xs font-bold uppercase tracking-[.16em] text-[#00C9A7]">Verified enquiry</p>
          ...
          <section className="mt-8 grid gap-5 md:grid-cols-2 xl:grid-cols-4">
            {contactRoutes.map(({ title, description, href, cta, icon: Icon }) => (
              <a key={title} href={href} className="rounded-xl border border-[#E5E7EB] bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-2xl hover:shadow-slate-200/80">
                <div className="inline-flex rounded-2xl bg-[#E6FBF7] p-3 text-[#00C9A7]"><Icon size={22} /></div>
          ...
          <section className="mt-8 grid gap-8 lg:grid-cols-[1fr_360px]">
            <div className="rounded-xl bg-white p-6 shadow-sm sm:p-8">
              ...
              <div className="mt-6 rounded-lg border border-[#E6FBF7] bg-[#f8fffd] p-5">
                <p className="text-xs font-bold uppercase tracking-[.14em] text-[#00C9A7]">Quick handoff hint</p>
              ...
              <div className="mt-4 rounded-lg border border-[#E5E7EB] bg-[#1A1A2E] p-5 text-white">
                <p className="text-xs font-bold uppercase tracking-[.14em] text-[#00C9A7]">Example note</p>
            ...
            <aside className="rounded-xl bg-[#1A1A2E] p-6 text-white shadow-sm sm:p-8">
              <UsersRound className="text-[#00C9A7]" size={30} />
              ...
              <div className="mt-6 space-y-3">
                {responseGuide.map(([label, text]) => (
                  <div key={label} className="rounded-2xl border border-white/10 bg-white/5 p-4">
                    <p className="text-xs font-bold uppercase tracking-[.14em] text-[#00C9A7]">{label}</p>
              ...
              <p className="mt-4 flex items-center gap-2 text-sm font-bold leading-6 text-white/60">
                <PhoneCall size={16} className="text-[#00C9A7]" /> Response via email until a richer helpdesk workflow lands.
              </p>
            </aside>
          </section>
          ...
          <section className="mt-8 grid gap-8 lg:grid-cols-[1.1fr_.9fr]">
            <div className="rounded-xl bg-white p-6 shadow-sm sm:p-8">
              ...
              <div className="mt-6 rounded-lg border border-[#E6FBF7] bg-[#f8fffd] p-5">
                <p className="text-xs font-bold uppercase tracking-[.14em] text-[#00C9A7]">Sample routed note</p>
                <p className="mt-2 text-sm font-bold leading-6 text-[#00C9A7]">
