    ...
    <main className="proppd-page">
      ...
      <section className="border-b border-[#E5E7EB] bg-white px-4 py-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <form action="/properties/for-sale" className="grid gap-3 rounded-lg border border-[#E5E7EB] bg-white p-4 shadow-sm xl:grid-cols-[1.6fr_1fr_1fr_auto] xl:items-end">
