        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-5 lg:grid-cols-3">
            ...
            <section className="rounded-xl border border-[#E5E7EB] bg-[#E6FBF7] p-6 shadow-sm">
              ...
              <h2 className="mt-2 text-2xl font-bold tracking-[-.04em] text-[#00C9A7]">Turn the current rental set into a clean handoff.</h2>
              <p className="mt-4 text-sm font-bold leading-6 text-[#00C9A7]">Save the search, then email it to a tenant or co-buyer with the filters already captured.</p>
              <div className="mt-5 flex flex-wrap gap-3">
                ...
                <a className="rounded-full border border-[#00C9A7]/20 px-5 py-3 text-sm font-bold text-[#00C9A7]" href="/agents">Browse agents</a>
              </div>
            </section>
          </div>
        </div>
