    ...
    <main className="proppd-page">
      ...
      <section className="border-b border-[#E5E7EB] bg-white px-4 py-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <form action="/properties/to-rent" className="rounded-xl border border-[#E5E7EB] bg-white p-3 shadow-sm sm:p-4">
            ...
            <div className="mt-3 flex justify-end gap-2">
              <a className="inline-flex min-h-11 items-center justify-center rounded-full border border-slate-300 bg-white px-5 text-sm font-bold text-[#1A1A2E] shadow-sm transition hover:border-[#4A3AFF]" href="/properties/to-rent">
                Clear
              </a>
