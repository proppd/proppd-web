    ...
    <main className="min-h-screen bg-[#F5F7FA] text-[#050A30]">
      ...
      <section className="px-4 py-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl rounded-[2.5rem] border border-slate-200 bg-white p-8 shadow-sm sm:p-12">
          ...
          <h1 className="mt-4 text-5xl font-black tracking-[-.07em] sm:text-6xl">Modern agency profiles</h1>
          <p className="mt-5 max-w-2xl text-lg leading-8 text-slate-600">A directory foundation for agencies, branch details, agents, and active listings.</p>
