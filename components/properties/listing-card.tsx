  ...
  return (
    <article className="group overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition hover:-translate-y-1 hover:shadow-2xl hover:shadow-slate-200/80">
      <a href={`/property/${listing.slug}`} className="block">
        <div className={`relative h-56 bg-gradient-to-br ${listing.gradient} p-4 text-white`}>
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_25%_18%,rgba(255,255,255,.38),transparent_13rem),linear-gradient(180deg,rgba(5,10,48,0)_30%,rgba(5,10,48,.68)_100%)]" />
          ...
          <div className="relative mt-24 flex items-end justify-between gap-4">
            ...
            <span className="rounded-lg border border-white/30 bg-white/15 px-3 py-2 text-xs font-black backdrop-blur">1 / 18</span>
          </div>
        </div>
        <div className="p-5">
