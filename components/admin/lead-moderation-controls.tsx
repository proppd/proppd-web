...
const ACTIONS: Array<{
...
}> = [
  {
    ...
    tone: 'default',
    disabledWhen: (status) => status === 'contacted' || status === 'archived',
  },
  {
    key: 'qualified',
    label: 'Qualified',
    ...
    tone: 'success',
    disabledWhen: (status) => status === 'qualified' || status === 'archived',
  },
  {
    key: 'archive',
    label: 'Archive',
    ...
    tone: 'warning',
    disabledWhen: (status) => status === 'archived',
  },
  {
    key: 'reopen',
    label: 'Reopen',
  ...
  },
  {
    ...
    tone: 'warning',
    disabledWhen: (status, quality) => status === 'archived' || quality === 'flagged',
  },
  {
    key: 'clean',
    label: 'Clear flag',
    body: { quality: 'clean' },
    tone: 'default',
    disabledWhen: (status, quality) => status === 'archived' || quality === 'clean',
  },
];
