...
const ACTIONS: Array<{
  ...
  },
  {
    ...
    tone: 'warning',
    disabledWhen: (status) => status === 'not_interested',
  },
  {
    key: 'fake_spam',
    label: 'Fake / spam',
    body: { status: 'fake_spam' },
    tone: 'warning',
    disabledWhen: (status) => status === 'fake_spam',
  },
  {
    key: 'reopen',
    label: 'Reopen',
    body: { status: 'new' },
    tone: 'default',
    disabledWhen: (status) => status === 'new',
  },
  {
    key: 'flagged',
    label: 'Flag review',
    ...
    tone: 'warning',
    disabledWhen: (status, quality) => quality === 'flagged',
  },
  {
    key: 'clean',
    label: 'Clear flag',
    body: { quality: 'clean' },
    tone: 'default',
    disabledWhen: (status, quality) => quality === 'clean',
  },
];
